...
class PandemicView extends AbstractView {
    ...
    public function makePandemicPage($pandemic, $id){
        ...
        $this->css = "./../css/ListPage.css";
        $this->content = "<p>{$pandemic->getName()} est une maladie du type {$pandemic->getSpecies()} dont l'existence remonte à {$pandemic->getAge()} ans.</p><a href=\"{$this->router->getConfigurableURL("pandemic_update", array("id" => $id))}\">Modifier Pandemic</a>&nbsp;&nbsp;<a href=\"{$this->router->getConfigurableURL("pandemic_delete", array("id" => $id))}\">Supprimer Pandemic</a>";
    }
